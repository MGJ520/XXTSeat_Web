...
function pustSignIn() {
    ...
    const password_login_local = document.getElementById('password_login_local').value.trim();
...
function postSignUp() {
    ...
    const password_register_local = document.getElementById('password_register_local').value.trim();
